...
tstat1<-t.test(xrf,icp,var.equal=TRUE)#pooled varience
tstat1p<-tstat1[[3]]


tstat2<-t.test(xrf,icp,paired=TRUE)#paired t test
tstat2p<-tstat2[[3]]
```
...
legend("topright",pch=1,col=c("black","green"),legend=c("Data pdf","Fitted pdf"),bty="n")
```
