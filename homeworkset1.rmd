...
It becomes much clear by plotting the various mean pdfs with the orignal dataset.
...
With more draws being meaned (ie 200 vs 10), the pdf is more symmetric, more "gaussian-like", closer to being centered at the mean, and has a smaller variance, demonstrating the Central Limit Theorem.
...
Suppose we now compare that with a uniformly-distributed dataset.    
